...
$valida1 = empty($KeyGet) ? header("Location: https://portal.ubm.br/FrameHTML/web/app/edu/PortalEducacional/#/") : 'Parâmetro preenchido';
...
if ($response->HttpStatusCode == 500) {
    echo ("<script>
        ...
        window.location = 'https://portal.ubm.br/FrameHTML/web/app/edu/PortalEducacional/#/';
        </script>");
} else {
