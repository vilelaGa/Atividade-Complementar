...
class SelectUsuario
{
    ...
    public static function TrazCursos()
    {
        ...
        SCURSO SCU (NOLOCK) ON SHF.CODCOLIGADA = SCU.CODCOLIGADA AND SHF.CODCURSO = SCU.CODCURSO', 'LEFT(SPL.CODPERLET, 4) = 2023 AND SPL.CODTIPOCURSO IN (1, 8)')
     ...
     * CODGRADE = no
     */
    public static function trazDuracao($CODCOLIGADA, $CODCURSO, $CODHABILITACAO, $CODGRADE)
    {
        $consulta = (new DbConsulta())->trazDuracaoQuery("SGR.CODCOLIGADA = '$CODCOLIGADA' AND SGR.CODCURSO = '$CODCURSO' AND SGR.CODHABILITACAO = '$CODHABILITACAO' AND  SGR.CODGRADE = '$CODGRADE'")
            ->fetch(PDO::FETCH_ASSOC);
        return $consulta;
    }
}
